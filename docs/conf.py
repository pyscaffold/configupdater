...
try:
    from configupdater import __version__ as version
except ImportError:
    pass
else:
    release = version
...
# of the sidebar.
# html_logo = "gfx/configupdater-254x128.png"

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = "gfx/favicon.ico"
...
htmlhelp_basename = "configupdater-doc"
